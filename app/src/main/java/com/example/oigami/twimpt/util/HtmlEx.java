...
import com.example.oigami.twimpt.R;
...
public class HtmlEx {
  ...
  public static interface TagHandler {
    ...
    public void handleTag(boolean opening, String tag,
                          Editable output,Attributes attributes, XMLReader xmlReader);
  }
...
class HtmlToSpannedConverter implements ContentHandler {
  ...
  private HtmlEx.TagHandler mTagHandler;

  public HtmlToSpannedConverter(
          String source, Html.ImageGetter imageGetter, HtmlEx.TagHandler tagHandler,
          Parser parser) {
    mSource = source;
  ...
  private void handleStartTag(String tag, Attributes attributes) {
    if (tag.equalsIgnoreCase("br")) {
      ...
      mTagHandler.handleTag(true, tag, mSpannableStringBuilder,attributes, mReader);
    }
  }
  ...
  private void handleEndTag(String tag) {
    if (tag.equalsIgnoreCase("br")) {
      ...
      mTagHandler.handleTag(false, tag, mSpannableStringBuilder,null, mReader);
    }
  }
  ...
  private static void startImg(SpannableStringBuilder text,
    ...
    if (d == null) {
      d = Resources.getSystem().
              getDrawable(R.drawable.abc_ab_bottom_solid_dark_holo);
